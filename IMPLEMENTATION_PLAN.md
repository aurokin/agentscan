...
- isolated daemon integration tests now cover title updates, pane add/remove topology changes, attached-session removal, wrapper-metadata helper flows, and fail-fast tmux server disappearance
