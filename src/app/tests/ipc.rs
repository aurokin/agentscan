...
fn ipc_frame_accepts_subscribe_mode() {
    let bytes = br#"{"type":"hello","protocol_version":2,"snapshot_schema_version":5,"mode":"subscribe"}"#;
...
fn ipc_frame_accepts_lifecycle_status_mode() {
    let bytes = br#"{"type":"hello","protocol_version":2,"snapshot_schema_version":5,"mode":"lifecycle_status"}"#;
...
fn ipc_frame_accepts_client_event() {
    let bytes = br#"{"type":"client_event","protocol_version":2,"snapshot_schema_version":5,"event":{"kind":"pane_focus","pane_id":"%42"}}"#;
